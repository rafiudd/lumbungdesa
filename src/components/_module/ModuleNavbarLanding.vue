  ...
  computed: {
    ...
    logo() {
        return this.scrollPosition > 98
               ? require('/Users/rafiudd/Documents/code-playground/Project_haji/src/assets/images/colored_logo.svg')
               : require('/Users/rafiudd/Documents/code-playground/Project_haji/src/assets/images/logo.svg');
    }
  },
